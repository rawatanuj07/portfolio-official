...
export default function Home() {
  ...
  // Prevent body scroll during startup phase
  useEffect(() => {
  ...
  const meta = {
    title: "Anuj Rawat - Full Stack Software Engineer",
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content={`https://decode-parvati.tech`} />
        <link rel="canonical" href={`https://decode-parvati.tech`} />
      ...
      {!isBlackListed ? (
        <div className="relative min-h-screen bg-AAprimary w-full overflow-hidden">
          {context.sharedState.finishedLoading ? (
            <></>
          ...
          {context.sharedState.finishedLoading ? (
            <Footer
              githubUrl={"https://github.com/rawatanuj07"}
