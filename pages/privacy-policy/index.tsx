    ...
    <div className="bg-gray-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto bg-white shadow-xl rounded-lg overflow-hidden">
        <div className="px-4 py-5 sm:p-6">
          ...
          <p className="text-sm text-gray-600 mb-8">Effective Date: 5 Oct 2025</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              The website <a href="https://decode-parvati.tech" className="text-blue-600 hover:text-blue-800 transition duration-300">anaflous.com</a> serves as my personal portfolio where I share my resume and software projects.
            </p>
            <p className="text-gray-700">
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              Email: <a href="mailto:your.email@example.com" className="text-blue-600 hover:text-blue-800 transition duration-300">decode-parvati.tech</a>
            </p>
          </section>
        </div>
      </div>
