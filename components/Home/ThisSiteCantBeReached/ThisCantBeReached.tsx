...
export default function ThisCantBeReached() {
  ...
  if (!isClient) {
    // Render static version on server to avoid mismatch
    return <span style={{ opacity: 0, transform: "translateX(-13px) translateY(30px) translateZ(0)" }}>...</span>;
  }
  return (
    <motion.div
      initial={{ opacity: 1 }}
      ...
      <div className="relative w-full  flex flex-col space-y-4">
        ...
        >
          ...
          <span className="text-gray-500 text-md">
            <span className="font-bold">www.decode-parvati.tech </span>
            unexpectedly{" "}
            {ShowText ? (
              <motion.span
