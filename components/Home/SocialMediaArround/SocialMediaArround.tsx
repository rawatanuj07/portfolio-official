    ...
    <>
      ...
      >
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex bg-AAprimary p-1 rounded-2xl flex-col justify-center items-center space-y-5">
            {/* Github Icon */}
            <IconClickableWithAnimation
              Icon={GithubIcon}
              href={"https://github.com/rawatanuj07"}
            />
            {/* Linkedin icon */}
            <IconClickableWithAnimation
              Icon={LinkedinIcon}
            ...
            />
            {/* Instagram Icon */}
            <IconClickableWithAnimation Icon={InstagramIcon} href={"https://www.instagram.com/rawatanuj07/"} />
            {/* Youtube Icon */}
            <IconClickableWithAnimation
              Icon={UpworkIcon}
              href={"https://www.upwork.com/freelancers/~01abfbedb585eb8b04?mp_source=share"}
            />
          </div>
      ...
      >
        <div className="flex flex-col space-y-24 justify-center items-center">
          ...
          <motion.div
            ...
            className="bg-AAprimary p-2 py-2 rounded-2xl"
          >
            <a
              href="mailto:rawatanuj07@gmail.com"
              target={"_blank"}
              rel="noreferrer"
            >
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                rawatanuj07<span className="text-AAsecondary">@</span>gmail
